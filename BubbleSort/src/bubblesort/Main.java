...
public class Main {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        obj.writeToFile("bubbleSortTime.csv",obj.estimatedTotalTime(start, end));
        obj.writeToFile("bubbleSortCPU.csv", cpuPercent);
        obj.writeToFile("bubbleSortMemory.csv",obj.getUsedMemory(mem0, mem1));
        Thread.sleep(3000);
        runtime.gc();
